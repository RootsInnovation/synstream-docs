...
const config = {
  ...
  tagline: 'Everything you need to build with Synstream',
  ...
  url: 'https://rootsinnovation.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/synstream-docs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'RootsInnovation', // Usually your GitHub org/user name.
  projectName: 'synstream-docs', // Usually your repo name.
  ...
  plugins: [
    ...
    [
      '@easyops-cn/docusaurus-search-local',
      {
        ...
        indexBlog: false,
        indexPages: false,
        docsRouteBasePath: ['docs', 'developers'],
        docsDir: ['docs', 'docs-developers'],
      },
    ],
  ],
